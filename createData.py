...
def createEntity(NAME, COMPANY, DEPART1, DEPART2, TITLE1, TITLE2, TITLE3, MOBILE1, MOBILE2, TEL1, TEL2, FAX1, FAX2, EMAIL1, EMAIL2, ADDRESS1, ADDRESS2, WEBSITE, DESCRIPTION, url):
    data = {
        FIELD_ID_1: NAME,        
        FIELD_ID_2: COMPANY,     
        FIELD_ID_3: DEPART1,       
